...
class JuheTrafficApi extends JuheFeesApi
{
    ...
    const KEY = '44130b80a8966318035e068431ce61aa';
    ...
    {
        return md5(static::OPEN_ID . static::KEY . $params['phone'] . $params['pid'] . $params['orderid']);
    }
