 ...
 * @package BaseComponents\extensions\alipay\buildermodel
 * @property AlipayTradePayExtendParamsBuilder $extendParamsBuilder
 */
class AlipayTradeWapPayContentBuilder
{
    ...
    {
        if ($this->extendParamsBuilder != null) {
            $this->bizContentarr['extend_params'] = $this->extendParamsBuilder->getBuildParams();
        }
    ...
    public function setExtendParamsBuilder(AlipayTradePayExtendParamsBuilder $extendParamsBuilder)
    {
        $this->extendParamsBuilder = $extendParamsBuilder;
    }

    public function getExtendParamsBuilder()
    {
        return $this->extendParamsBuilder;
    }
}
