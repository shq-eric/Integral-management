...
namespace yii\imagine\Imagine\Filter;

use yii\imagine\Imagine\Exception\InvalidArgumentException;
use yii\imagine\Imagine\Filter\Basic\ApplyMask;
use yii\imagine\Imagine\Filter\Basic\Copy;
use yii\imagine\Imagine\Filter\Basic\Crop;
use yii\imagine\Imagine\Filter\Basic\Fill;
use yii\imagine\Imagine\Filter\Basic\FlipVertically;
use yii\imagine\Imagine\Filter\Basic\FlipHorizontally;
use yii\imagine\Imagine\Filter\Basic\Paste;
use yii\imagine\Imagine\Filter\Basic\Resize;
use yii\imagine\Imagine\Filter\Basic\Rotate;
use yii\imagine\Imagine\Filter\Basic\Save;
use yii\imagine\Imagine\Filter\Basic\Show;
use yii\imagine\Imagine\Filter\Basic\Strip;
use yii\imagine\Imagine\Filter\Basic\Thumbnail;
...
use yii\imagine\Imagine\Image\ManipulatorInterface;
